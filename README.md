...
- Для первой задачи необходимо запросить у пользователя размеры массива N (число строк) и M (число столбцов); создать два двумерных массива для хранения - действительных частей комплексных чисел и мнмых частей комплексных чисел; ввести элементы массива в формате 𝑎 + 𝑏𝑖, где: 𝑎 — действительная часть, 𝑏 — мнимая часть. (пусть a и b больше 0)
...
**Тест 3: Мнимые части равны нулю**
